...
2. ⛔ 출발지 위도, 출발지 경도, 두 점 사이의_각도_, 거리를 인자로 넘겨주면 원하는 곳의 위도, 경도 값을 얻을 수 있는 polygon-coordinates 모듈 사용하기.
...
생각을 전환하여 위도, 경도 값을 먼저 구하고 그 자리에 마커를 위치 시키게 해봐야겠다고 계획은 변경하였습니다. <br>
결과적으로 해결할 수 있었습니다.
